...
if($radio==1 && $filtro!="" && (int)$filtro){
	$sql.=" WHERE id_tipo_tras = '".$filtro."' ";
}
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" WHERE UPPER(des_tipo_tras) LIKE UPPER('%".$filtro."%') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Descripción');
$arraydb=array('id_tipo_tras','id_tipo_tras','des_tipo_tras');
$title="TABLA TIPO TRASLADOS";
$del="frmdeltipotraslados.php";
$frm="frminstipotraslados.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
