...
if($radio==1 && $filtro!="" && (int)$filtro){
	$sql.=" WHERE id_org_fin = '".$filtro."' ";
}
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" WHERE UPPER(des_org_fin) LIKE UPPER('%".$filtro."%') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Descripción');
$arraydb=array('id_org_fin','id_org_fin','des_org_fin');
$title="TABLA FINANCIADOR";
$del="frmdelorgfin.php";
$frm="frminsorgfin.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
