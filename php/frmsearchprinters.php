...
$ifcodp=" WHERE cod_pat_mh <>'' AND id_desc=14 ";
#codigo patrmonial nuevo
$tablecodn="bienes";
$pkcodn="codpatnew";
$descodn="codpatnew";
$arraycodn=array('codpatnew');
$ifcodn=" WHERE codpatnew <>'' AND id_desc=14 ";
#Table Marcas
$tablemarca="marcas";
$pkmarca="id_marca";
$desmarca="des_marca";
...
?>
<form id="frmsearchprinters" name="frmsearchprinters" method="post" onSubmit="search1('searchprinters.php','#frmsearchprinters');return false;">
	<table class="tablereg1">
    <tr>
      <th colspan="6">Buscar Impresoras</th>
    </tr>
    <tr>
      <td>Responsable</td>
