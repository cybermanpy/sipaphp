...
<link rel="stylesheet" href="../css/stylesmain.css" /><title>.::INVENTARIO:.</title>
</head>
...
$sql.=" WHERE id_tipo_doc='".$pk."'";
$res = connector1($user,$pass,$sql);
$row=fetchArray($res);
$rows=getNumRows($res);
$pkt='id_tipo_doc';
$pages='viewtipodocs.php';
if($rows>0){
?>
...
<table id="tablereg" class="tablereg">
  <tr>
  	<th colspan="2">Borrar Tipo documentos</th>
  </tr>
  <tr>
    <td>PK </td>
  ...
  <tr>
    <td>Descripción</td>
    <td><input type="text" id="des" name="des"  value="<?=$row['des_tipo_doc']?>" /></td>
  </tr>
  <tr>
