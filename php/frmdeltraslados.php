...
$sql.=" WHERE id_traslado='".$pk."'";
$res = connector1($user,$pass,$sql);
$row=fetchArray($res);
$rows=getNumRows($res);
$pkt='id_traslado';
$pages='viewtraslados.php';
if($rows>0){
?>
<form id="form" name="form" method="post" onSubmit="borrar1('deletetras.php','#form');return false;">
...
<table id="tablereg" class="tablereg">
  <tr>
  	<th colspan="2">Borrar Traslado</th>
  </tr>
  <tr>
    <td>PK </td>
  ...
  <tr>
    <td>Descripción</td>
    <td><input type="text" id="pkbien" name="pkbien"  value="<?=$row['bien_id']?>" /></td>
  </tr>
  <tr>
