...
include'../includes/pagesusers.php';
...
$del="deleteusers.php";
$frm="frminsusers.php";
$lockadd='frmpermit.php';
$lockbreak='frmdeny.php';
$filtro1="SysID";
$filtro2="Usuario";
$filtro3="";
$filtro4="";
$filtro5="";
$filtro6="";
page($res,$total,$pagtam,$page,$inicio,$arraydb,$arrayhead,$title,$index,$frm,$del,$orden,$type,$lockadd,$lockbreak);
?>
</body>
</html>