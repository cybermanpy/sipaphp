...
?>
<form id="frmpermit" name="frmpermit" method="post" onSubmit="permit('insertpermit.php','#frmpermit');return false;">
  <table class="tablereg">
  	  <tr>
      	<th bgcolor="#8f7156" colspan="6">Asignar Permisos <br><input type="hidden" id="user" name="user" value="<?= $_GET['pk']?>" />Usuario: <?= $_GET['pk']?></th>
      </tr>
      <tr bgcolor="#8f7156">
          <td>Tablas</td>
          <td>Select</td>
      ...
      ?>
      <tr>
          <td colspan="5"><input class="boton" type="submit" id="send" name="send" value="Asignar" /></td>
      </tr>
  </table>
</form>
</body>
