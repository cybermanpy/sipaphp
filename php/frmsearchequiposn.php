...
?>
<form id="frmsearcheq" name="frmsearcheq" method="post" onSubmit="search1('searcheq1.php','#frmsearcheq');return false;">
	<table class="tablereg1">
    <tr>
      <th colspan="6">Buscar Bienes sin fichas</th>
    </tr>
    <tr>
      <td>Responsable</td>
