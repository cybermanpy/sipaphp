...
if($radio==1 && $filtro!="" && (int)$filtro){
	$sql.=" AND id_conserv = '".$filtro."' ";
}
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" AND UPPER(des_conserv) LIKE UPPER('%".$filtro."%') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Descripción');
$arraydb=array('id_conserv','id_conserv','des_conserv');
$title="TABLA CONSERVACIONES";
$del="frmdelconservaciones.php";
$frm="frminsconservaciones.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
