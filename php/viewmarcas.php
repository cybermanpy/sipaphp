...
if($radio==1 && $filtro!="" && (int)$filtro){
	$sql.=" WHERE id_marca = '".$filtro."' ";
}
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" WHERE UPPER(des_marca) LIKE UPPER('%".$filtro."%') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Descripción');
$arraydb=array('id_marca','id_marca','des_marca');
$title="TABLA MARCAS";
$del="frmdelmarcas.php";
$frm="frminsmarcas.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
