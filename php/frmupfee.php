...
?>
<div id="form">
<form id="frmupfee" name="frmupfee" action="insertfee.php" method="post" enctype="multipart/form-data" target="iframeUp">
	<table id="tablereg" class="tablereg">
    	<tr>
        	<th colspan="2">Subir Formulario Entrega de equipos</th>
        </tr>
        <tr>
        	<td>PK</td>
