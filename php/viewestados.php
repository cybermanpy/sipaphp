...
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" WHERE UPPER(des_estado) LIKE UPPER('%".$filtro."%') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Descripción');
$arraydb=array('id_estado','id_estado','des_estado');
$title="TABLA ESTADOS";
$del="frmdelestados.php";
$frm="frminsestados.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
