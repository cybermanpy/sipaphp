...
$pk=$_GET['pk'];
$table='fichas';
$array=array('id_ficha','id_bien');
$sql=select($table,$array);
$sql.=" WHERE id_ficha='".$pk."'";
$res = connector1($user,$pass,$sql);
$row=fetchArray($res);
$rows=getNumRows($res);
$pkt='id_ficha';
$pages='viewfichas.php';
if($rows>0){
?>
...
<table id="tablereg" class="tablereg">
  ...
  <tr>
    <td>Descripción</td>
    <td><input type="text" id="des" name="des"  value="<?=$row['id_bien']?>" /></td>
  </tr>
  <tr>
