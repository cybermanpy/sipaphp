...
if($radio==1 && $filtro!="" && (int)$filtro){
	$sql.=" WHERE id_prov = '".$filtro."' ";
}
if($radio==2 && $filtro!="" && $filtro){
	$sql.=" WHERE UPPER(nom_prov) = UPPER('".$filtro."') ";
}
$sql.=" ORDER BY ".$orden." ".$type." LIMIT ".$pagtam." OFFSET ".$inicio;
$res=connector1($user,$pass,$sql);
$arrayhead=array('Tareas','PK','Proveedor','Contacto','Télefono','Dirección','Correo','WEB');
$arraydb=array('id_prov','id_prov','nom_prov','contacto','telefono','direccion','correo','web');
$title="TABLA PROVEEDORES";
$del="frmdelproveedores.php";
$frm="frminsproveedores.php";
$filtro1="PK";
$filtro2="Descripción";
$filtro3="";
$filtro4="";
